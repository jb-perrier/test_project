...
## Title
Make the IA looks more human

## User Need
The IA is very strong, always choose the closest path, make it looks more like human, so the gameplay feels less always the same.
