...
Last Implementation Commit: 8f1cefcc958f7289fe8d3dde21af82fd3cfea2ec
Review Loop Count: 1
...
Head commit: 8f1cefcc958f7289fe8d3dde21af82fd3cfea2ec
...
+
   #[test]
@@ -931,2 +1059,16 @@ mod tests {
 
+  #[test]
+  fn enemy_replan_tick_still_prefers_the_safe_turn_that_closes_food_distance() {
+    let mut rng = seeded_rng();
+    let mut game = Game::new(7, 7, &mut rng);
+
+    game.phase = Phase::Running;
...
+
+    assert_eq!(enemy_choice(&game, Direction::Right, 7), Direction::Up);
+  }
+
   #[test]
@@ -1065,2 +1207,3 @@ mod tests {
