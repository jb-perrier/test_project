...
## Change Summary
- The canonical project spec now records the Snake sample's `ratatui`-based terminal UI in the workspace overview instead of using a story-named spec file.
